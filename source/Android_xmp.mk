...
LOCAL_CFLAGS := -Dstricmp=strcasecmp -Dstrnicmp=strncasecmp -Wall -Wextra -Wno-unused-parameter -fomit-frame-pointer -fsigned-char  -DHAVE_POWF=1 -DLIBXMP_STATIC=1 -DLIBXMP_NO_PROWIZARD=1 -DLIBXMP_NO_DEPACKERS=1
